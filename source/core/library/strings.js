...
export const strings = {
  en: {
    ...
    [UNABLE_TO_DOWNLOAD_PRESETS]: 'Unable to download the default presets at \'https://www.datapopulator.com/demodata/\' provided by precious design studio.',
    [NO_JSON_FILES_IN_PRESETS_FOLDER]: 'There are no JSON files in the presets folder to populate with.',
    ...
    [LAST_USED_DATA_DESCRIPTION]: 'Your last used command, JSON, data path, data options and default substitute are shown below.',
    [COMMAND]: 'Command',
    ...
    [PRESETS_LIBRARY_NOT_FOUND]: "Presets library was not found. Please set it via 'Set Presets Library'",
